  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-16 md:py-24">
          ...
          duration: 0.6
            ...
            <h1 className="font-mono text-4xl font-bold mb-6 text-primary md:text-7xl">Master Engineering Drawing<span className="gradient-text">Technical Drawing</span>
            </h1>
          ...
          delay: 0.2
            ...
            icon: Brain,
            text: "AI Evaluation"
          }].map((item, index) => <div key={index} className="flex items-center gap-2 px-4 py-2 rounded-full bg-card border border-border shadow-sm">
      ...
      <section className="relative">
        <div className="container mx-auto px-4 pb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 max-w-5xl mx-auto">
          ...
          }].map((branch, index) => <motion.div key={branch.code} initial={{
            opacity: 0,
            y: 20
          }} animate={{
            opacity: 1,
            ...
            scale: 0.98
          }} onClick={() => navigate(`/branch/${branch.code.toLowerCase()}`)} className="group relative cursor-pointer">
